...
public class CouponActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvId2 = (TextView) findViewById(R.id.tvId2); //텍스트뷰 ID 찾기
        ...
        beaconManager.setRangingListener(new BeaconManager.RangingListener() {
            ...
            public void onBeaconsDiscovered(Region region, List< Beacon > list) {  /**비콘을 받아오는 소스, 수신 범위를 갱신받는다. */
                if (!list.isEmpty()) {
                    ...
                    tvId2.setText(nearestBeacon.getRssi() + "");// nearestBeacon.getRssi() : 비콘의 수신 강도
                    tvId2.setTextSize(40);
                    ...
                    // 수신강도가 -70 이하일때 알림창을 띄운다.
                        ...
                        Toast.makeText(CouponActivity.this, "연결해제됨.", Toast.LENGTH_SHORT).show();
                        isConnected = false;
                    }
                }
            }
        ...
        beaconManager2.setRangingListener(new BeaconManager.RangingListener() {
            ...
            public void onBeaconsDiscovered(Region region2, List<Beacon> list) {
                if (!list.isEmpty()) {
                    ...
                    tvId2.setText(nearestBeacon2.getRssi() + "");// nearestBeacon.getRssi() : 비콘의 수신 강도
                    tvId2.setTextSize(10);

                    // 수신강도가 -70 이상일때 알림창을 띄운다.
                    if (!isConnected && nearestBeacon2.getRssi() > -70) {
                        isConnected = true;
                        Toast.makeText(CouponActivity.this, "두번째비콘 연결완료.", Toast.LENGTH_SHORT).show();
                    }
                    // 수신강도가 -70 이하일때 알림창을 띄운다.
                    else if (isConnected && nearestBeacon2.getRssi() < -70) {
                        Toast.makeText(CouponActivity.this, "두번째비콘 연결해제.", Toast.LENGTH_SHORT).show();
                        isConnected = false;
                    }
                }
            }
